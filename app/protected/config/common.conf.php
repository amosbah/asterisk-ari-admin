...
$config['SUPERVISOR_HOST'] = "0.0.0.0";
$config['SUPERVISOR_URL'] = "http://0.0.0.0:9001";
$config['SUPERVISORCTL_BIN'] = '/usr/bin/supervisorctl';
$config['SUPERVISOR_CNF_FLD'] = '/etc/supervisord.d/';
$config['SUPERVISOR_USR'] = 'admin';
$config['SUPERVISOR_PWD'] = 'passwd';

$config['APPS_PATH'] = $config['SITE_PATH'] . 'global/apps/';
$config['SCRIPTS_PATH'] = $config['SITE_PATH'] . 'global/scripts/';;
