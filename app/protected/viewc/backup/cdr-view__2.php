...
<script src="<?php echo $data['rootUrl']; ?>global/public/javascripts/socket.io-client-2.0.3/dist/socket.io.js"></script>
<script type="text/javascript" language="javascript" class="init">
	$(document).ready(function() {
		var t = $('#Cdr').DataTable();
		t.row.add([ 1, 2, 3, 4, 5, 6 ]).draw(false);
...
<body class="dt-example dt-example-bootstrap">
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Vertical Panel with panel-primary
				class</div>
