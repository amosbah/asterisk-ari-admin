	...
	<div class="container">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <li><a href="<?php echo $data['rootUrl'] . 'scripts'; ?>"><span class="glyphicon glyphicon-file"></span> SCRIPTS</a></li>
        ...
        <div class="btn-group-vertical">
            <button type="button" class="btn btn-outline-primary">
                <span class="glyphicon glyphicon-search"></span> Apple
            </button>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<iframe allowtransparency="true" style="background: #FFFF00;" height="600px" width="100%" frameborder="0" src="http://127.0.0.1:9001/logtail/1537438011_example.js" name="iframe_a"></iframe>
				<div id="browse_app">
