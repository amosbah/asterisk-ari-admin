	...
	<div class="container">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<section>
					...
					<table id="Apps" class="table table-striped table-bordered"
						...
						<?php
						      ...
						      echo '<tr>';
							  echo '<td>' . '<a href=' . $data['rootUrl'] . 'apps/view/' . $app->{'id'} . '/' . '>' .$app->{'name'}. '</a>' . '</td>';
							  ...
							  echo '<td><div id="browse_app"><a class="btn btn-xs" href="' . $data['rootUrl'] . 'apps/start/' .$app->{'id'}. '"><span class="glyphicon glyphicon-ok"></span> START</a>';
							  echo '  <a class="btn btn-xs" href="' . $data['rootUrl'] . 'apps/stop/' .$app->{'id'}. '"><span class="glyphicon glyphicon-remove"></span> STOP</a>';
							  echo '  <a class="btn btn-xs" href="' . $data['rootUrl'] . 'apps/restart/' .$app->{'id'}. '"><span class="glyphicon glyphicon-refresh"></span> RESTART</a>';
							  echo '  <a class="btn btn-xs" href="' . $data['rootUrl'] . 'apps/del/' .$app->{'id'}. '"><span class="glyphicon glyphicon-trash"></span> DELETE</a>';
                              echo '  <a class="btn btn-xs" href="' . $data['rootUrl'] . 'apps/tail/' .$app->{'id'}. '"><span class="glyphicon glyphicon-align-justify"></span> TAIL</a></div></td>';
							echo '</tr>';
							}
						?>
						</tbody>
				...
				<div id="browse_app">
				      <a class="btn btn-large btn-success" href="<?php echo $data['rootUrl'] . 'apps/add';?>"><span class="glyphicon glyphicon-plus"></span> ADD</a>
				      <a class="btn btn-large btn-warning" href="<?php echo $data['rootUrl'] . 'apps';?>"><span class="glyphicon glyphicon-refresh"></span> REFRESH</a>
				</div>
