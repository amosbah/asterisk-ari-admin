...
<body class="dt-example dt-example-bootstrap">
    ...
    <div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">BRIDGES</div>
			<div class="panel-body">
				<section>
					<div class="demo-html"></div>
					<table id="Bridges" class="table table-striped table-bordered"
						...
						<tbody>
						<?php
						      foreach ($data['bridges'] as $bridge) {
						      echo '<tr>';
							  echo '<td>' . '<a href=' . $data['rootUrl'] . 'bridges/view/' . $bridge->{'id'} . '/' . '>' .$bridge->{'id'}. '</a>' . '</td>';
							  echo '<td>' . $bridge->{'technology'} . '</td>';
							  echo '<td>' . $bridge->{'bridge_type'} . '</td>';
							  echo '<td>' . $bridge->{'bridge_class'} . '</td>';							  
							echo '</tr>';
							}
						?>
						</tbody>
				...
				<div id="browse_app">
				      <a class="btn btn-large btn-success disabled" href="<?php echo $data['rootUrl'] . 'bridges/add';?>"><span class="glyphicon glyphicon-plus"></span> ADD</a>
				      <a class="btn btn-large btn-warning" href="<?php echo $data['rootUrl'] . 'bridges';?>"><span class="glyphicon glyphicon-refresh"></span> REFRESH</a>
				</div>
