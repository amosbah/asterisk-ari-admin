...
<body class="dt-example dt-example-bootstrap">
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo $data['rootUrl'] . 'apps'; ?>">SCRIPTS</a></li>
			<li class="active"><?php echo $data['name']; ?></li>
		</ol>
		<div class="panel panel-primary">
			<div class="panel-heading">
				SCRIPT: <?php echo $data['name']; ?>
			</div>
					...
					<table id="AppItem" class="table table-striped table-bordered"
						...
						<tbody>
							...
							<tr>
								...
								<td>
								      <div id="browse_app">
									    <a class="btn btn-success btn-xs" href="<?php echo  $data['rootUrl'] . 'apps/start/' .$data['id']; ?>"><span class="glyphicon glyphicon-ok"></span> START</a>
									    <a class="btn btn-warning btn-xs" href="<?php echo  $data['rootUrl'] . 'apps/stop/' .$data['id']; ?>"><span class="glyphicon glyphicon-remove"></span> STOP</a>
									    <a class="btn btn-info btn-xs" href="<?php echo  $data['rootUrl'] . 'apps/restart/' .$data['id']; ?>"><span class="glyphicon glyphicon-refresh"></span> RESTART</a>
								      </div>
