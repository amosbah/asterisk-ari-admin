	...
	<div class="container">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <li class="active"><a href="<?php echo $data['rootUrl'] . 'channels'; ?>"><span class="glyphicon glyphicon-random"></span> CHANNELS</a></li>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<section>
					...
					<table id="Chan" class="table table-striped table-bordered"
						...
						<?php
						      ...
						      echo '<tr>';
							  echo '<td>' . '<a href=' . $data['rootUrl'] . 'channels/view/' . $chan->{'id'} . '/' . '>' .$chan->{'id'}. '</a>' . '</td>';
							  echo '<td>' . $chan->{'name'} . '</td>';
							  if ($chan->{'state'} == 'Up') {
							      echo '<td><span class="label label-success">UP</span></td>';
							  }
							  else {
							  	echo '<td><span class="label label-info">' . $chan->{'state'} . '</span></td>';
							  }
							  echo '<td>' . $chan->{'creationtime'} . '</td>';
				...
				<div id="browse_app">
				      <a class="btn btn-large btn-success disabled" href="<?php echo $data['rootUrl'] . 'channels/add';?>"><span class="glyphicon glyphicon-plus"></span> ADD</a>
				      <a class="btn btn-large btn-warning" href="<?php echo $data['rootUrl'] . 'channels';?>"><span class="glyphicon glyphicon-refresh"></span> REFRESH</a>
				</div>
