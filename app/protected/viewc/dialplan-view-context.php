	...
	<div class="container">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div id="browse_app">
				    <a class="btn btn-large btn-success" href="<?php echo $data['rootUrl'] . 'dialplan';?>"><span class="glyphicon glyphicon-arrow-left"></span> BACK</a>
				</div>
